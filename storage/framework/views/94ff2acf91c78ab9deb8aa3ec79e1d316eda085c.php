  ...
  <div class="container py-4">
    ...
    <div class="row align-items-md-stretch mb-2">
      ...
      <?php $__currentLoopData = $loket; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $l): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>  
        <div class="col-md-6">
          <div class="h-100 p-5 <?php echo e($l->id == 1 ? 'bg-success' : 'bg-primary'); ?> text-white rounded-3">
            <h2>Antrian <?php echo e($l->deskripsi); ?></h2>
            <p>Klik tombol dibawah untuk mencetak antrian <?php echo e($l->deskripsi); ?></p>
            <a href="/antrian/<?php echo e(str_replace(' ', '_', strtolower($l->deskripsi))); ?>/<?php echo e($l->id); ?>" target="_blank" class="btn btn-outline-light btn-lg btn-block" id="cetakUmum"><i class="fa-solid fa-print"></i> Cetak Antrian</a>
          </div>
        </div>
...
<?php /**PATH D:\APLIKASI PROJECT\Aplikasi-Antrian-Klinik\resources\views/dashboard.blade.php ENDPATH**/ ?>