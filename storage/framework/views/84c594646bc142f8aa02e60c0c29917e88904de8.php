...
<html lang="en">
  <head>
    ...
    <title>Plasma Antrian POLIKLINIK</title>
                  ...
                  <div class="col-sm">
                      <div class="card text-center">
                        ...
                        <?php else: ?>
                          ...
                          <h5 class="card-header bg-success text-white">ANTRIAN <?php echo e(strtoupper( $layanan[0]->nama_layanan)); ?></h5>
                          <div class="card-body">
                            <h5 class="card-title">Jumlah Antrian Saat Ini</h5>
                            <h1 class="card-text" style="font-size: 100px; margin: 0;">
                              <?php echo e($data->count()); ?> 
                            </h1>
                          </div>
                          <h5 class="card-header bg-success text-white">PASIEN</h5>
                        <?php endif; ?>
                      </div>
                  </div>
              </div>
...
</html><?php /**PATH D:\APLIKASI PROJECT\Aplikasi-Antrian-Klinik\resources\views/dashboard/antrian/get_antrian_poli.blade.php ENDPATH**/ ?>