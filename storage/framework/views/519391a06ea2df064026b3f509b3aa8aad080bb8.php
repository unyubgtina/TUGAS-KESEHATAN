        ...
        <table class="styled-table">
            ...
            <tbody>
                ...
                <tr class="table-row">
                    ...
                    <td><?php echo e($b->pendaftaran->no_rm); ?></td>
                    <td><?php echo e($b->noregistrasi); ?></td>
                    <td><?php echo e($b->pendaftaran->nama); ?></td>
                    <td><?php echo e($b->layanan->nama_layanan); ?></td>
                    <td><?php echo e($b->created_at->format('d M Y')); ?></td>
                    <td><?php echo e($b->tipe_pasien); ?></td>                
                </tr>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    <th colspan="6" style="text-align: right; font-size: 16px">JUMLAH KUNJUNGAN BULAN INI : </th>
                    <th style="font-size: 16px"><?php echo e(count($bulan)); ?> Pasien</th>
                </tr>
        </tbody>
...
</html><?php /**PATH D:\APLIKASI PROJECT\Aplikasi-Antrian-Klinik\resources\views/dashboard/laporan/cetak-laporan.blade.php ENDPATH**/ ?>