...
unset($__errorArgs, $__bag); ?>" name="nama" id="nama" placeholder="Masukan Nama Lengkap" value="<?php echo e(old('nama')); ?>" autofocus>
...
unset($__errorArgs, $__bag); ?>" name="ttl" id="ttl" value="<?php echo e(old('ttl')); ?>">
              <?php $__errorArgs = ['ttl'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>" name="no_ktp" id="no_ktp" placeholder="Masukan No KTP" value="<?php echo e(old('no_ktp')); ?>">
...
unset($__errorArgs, $__bag); ?>" name="no_hp" id="no_hp" placeholder="Masukan NO Handphone" value="<?php echo e(old('no_hp')); ?>">
...
unset($__errorArgs, $__bag); ?>" name="pj" id="pj" placeholder="Masukan Nama Penanggung Jawab" value="<?php echo e(old('pj')); ?>">
                  <?php $__errorArgs = ['pj'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>" name="no_pj" id="no_pj" placeholder="Masukan Nama Penanggung Jawab" value="<?php echo e(old('no_pj')); ?>">
...
unset($__errorArgs, $__bag); ?>" placeholder="Alamat" name="alamat" id="alamat" style="height: 100px"></textarea>
...
unset($__errorArgs, $__bag); ?>" name="pekerjaan" id="pekerjaan" placeholder="Masukan pekerjaan Lengkap" value="<?php echo e(old('pekerjaan')); ?>">
...
<?php echo $__env->make('dashboard.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\APLIKASI PROJECT\Aplikasi-Antrian-Klinik\resources\views/dashboard/pendaftaran/create.blade.php ENDPATH**/ ?>