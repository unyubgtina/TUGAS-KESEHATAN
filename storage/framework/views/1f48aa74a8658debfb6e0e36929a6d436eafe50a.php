<nav class="sidebar sidebar-offcanvas" id="sidebar">
      ...
      <li class="nav-item nav-profile">
        <a href="/dashboard" class="nav-link">
          ...
          <div class="nav-profile-text d-flex flex-column">
            ...
            <span class="text-secondary text-small"><?php echo e(auth()->user()->is_admin == 0 ? 'Karyawan' : 'Administrator'); ?></span>
          </div>
  ...
  </nav><?php /**PATH D:\APLIKASI PROJECT\Aplikasi-Antrian-Klinik\resources\views/dashboard/layouts/sidebar.blade.php ENDPATH**/ ?>