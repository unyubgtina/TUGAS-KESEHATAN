        ...
        <div class="main-panel">
          ...
          <footer class="footer">
            <div class="container-fluid d-flex justify-content-between">
              <span class="text-muted d-block text-center text-sm-start d-sm-inline-block">Copyright © Puskesmas Kota Serang <?php echo e(date('Y')); ?></span>
            </div>
          </footer>
          <!-- partial -->
        </div>
...
</html><?php /**PATH D:\APLIKASI PROJECT\Aplikasi-Antrian-Klinik\resources\views/dashboard/layouts/main.blade.php ENDPATH**/ ?>