      ...
      <div class="col-md-4 stretch-card grid-margin">
        <div class="card bg-gradient-danger card-img-holder text-white">
          <div class="card-body">
            ...
            <h2 class="mb-5"><?php echo e(count($pasien)); ?> Orang</h2>
      ...
      <div class="col-md-4 stretch-card grid-margin">
        <div class="card bg-gradient-info card-img-holder text-white">
          <div class="card-body">
            ...
            <h2 class="mb-5"><?php echo e(count($antrian)); ?> Antrian </h2>
      ...
      <div class="col-md-4 stretch-card grid-margin">
        <div class="card bg-gradient-success card-img-holder text-white">
          <div class="card-body">
            ...
            <h2 class="mb-5"><?php echo e(count($dokter)); ?> Orang</h2>
...
<?php echo $__env->make('dashboard.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\APLIKASI PROJECT\Aplikasi-Antrian-Klinik\resources\views/dashboard/index.blade.php ENDPATH**/ ?>