  ...
  <body>
    ...
    <nav class="navbar navbar-dark bg-success">
        <div class="container">
          ...
          <div class="d-flex">
            <h6 class="text-white"><?php echo e('Serang, ' . date('d-M-Y')); ?></h6>
          </div>
        </div>
    </nav>
              ...
              <div class="row p-2">
                  <div class="col-sm">
                      <div class="card text-center">
                        ...
                        <?php else: ?>
                          <h5 class="card-header bg-success text-white">ANTRIAN <?php echo e(strtoupper($loket1[0]->loket->deskripsi)); ?></h5>
                          <div class="card-body">
                            <h5 class="card-title">Nomor Antrian</h5>
                            <h1 class="card-text" style="font-size: 100px; margin: 0;">
                              <?php echo e($loket1[0]->no_antrian); ?>

                            </h1>
                          </div>
                          <h5 class="card-header bg-success text-white">LOKET <?php echo e($loket1[0]->loket->id); ?></h5>
                        <?php endif; ?>
                      </div>
                  </div>
              </div>
                ...
                <div class="col-sm">
                    <div class="card text-center">
                      <?php if(!$loket2->count()): ?>
                        <h5>Belum Ada Antrian</h5>
                      <?php else: ?>
                      <h5 class="card-header bg-success text-white">ANTRIAN <?php echo e(strtoupper($loket2[0]->loket->deskripsi)); ?></h5>
                      <div class="card-body">
                        <h5 class="card-title">Nomor Antrian</h5>
                        <h1 class="card-text" style="font-size: 100px; margin: 0;">
                          <?php echo e($loket2[0]->no_antrian); ?>

                        </h1>
                      </div>
                      <h5 class="card-header bg-success text-white">LOKET <?php echo e($loket2[0]->loket->id); ?></h5>
                      <?php endif; ?>
                    </div>
                </div>
            </div>
...
</html><?php /**PATH D:\APLIKASI PROJECT\Aplikasi-Antrian-Klinik\resources\views/plasma.blade.php ENDPATH**/ ?>